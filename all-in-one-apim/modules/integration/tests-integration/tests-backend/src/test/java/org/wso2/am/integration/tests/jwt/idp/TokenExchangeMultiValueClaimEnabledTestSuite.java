...
public class TokenExchangeMultiValueClaimEnabledTestSuite extends APIManagerLifecycleBaseTest {
    ...
    public void loadConfiguration() throws Exception {
        ...
        serverConfigurationManager.applyConfigurationWithoutRestart(new File(
                getAMResourceLocation() + File.separator + "configFiles" + File.separator + "idpjwtMultiValueClaim"
                        + File.separator + "deployment.toml"));
        serverConfigurationManager.applyConfigurationWithoutRestart(new File(
                getAMResourceLocation() + File.separator + "configFiles" + File.separator + "idpjwt" + File.separator
                        + "client-truststore" + ".jks"), targetFile, true);
