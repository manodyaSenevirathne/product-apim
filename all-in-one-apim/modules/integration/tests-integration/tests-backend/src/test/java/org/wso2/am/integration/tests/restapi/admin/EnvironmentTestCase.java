...
public class EnvironmentTestCase extends APIMIntegrationBaseTest {
    ...
    // Dedicated API and second gateway environment used to validate the Developer Portal Swagger server URL across
    // multiple gateway environments (self contained, independent of the other tests in this class).
    ...
    @Test(groups = {"wso2.am"},
            description = "Scenario 1: With multiple gateway environments in the tenant, an API deployed only to one of "
    ...
    @Test(groups = {"wso2.am"},
            description = "Scenario 2: When the API is undeployed from the previous gateway environment and deployed to "
    ...
    @Test(groups = {"wso2.am"},
            description = "Scenario 3: When the API is deployed to multiple gateway environments, the Developer Portal "
